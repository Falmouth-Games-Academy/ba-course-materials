...
void PrintFont(SDL_Texture* texture ,int x,int y,const char* text)
{
    const char*p = text;
...
int main(int argc, char *argv[]) 
{
	...
	{	
        ...
        SDL_SetTextureColorMod(fontTexture,255,255,255);
		PrintFont(fontTexture,100,100,"ABCDEFGHIJKLMNOPQRSTUVWXYZ");

        SDL_SetTextureColorMod(fontTexture,0,255,0);
        PrintFont(fontTexture,100,200,"abcdefghijklmnopqrstuvwxyz");
